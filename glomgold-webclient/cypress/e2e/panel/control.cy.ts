  ...
  describe("Panel Widgets", () => {
    ...
    describe("Month Items", () => {
      ...
      it("Add Item", () => {
        ...
        cy.intercept("GET", `/api/panel/item-complete?&description=${encodeURI(itemDesc)}`, { fixture: "panel/item-complete.json" }).as("itemComplete");
      ...
      it("Edit/Delete Item", () => {
        ...
        cy.get("div.ant-popover-inner button.ant-btn-primary")
          .should("exist")
          .click();
      ...
      it("Delete Items", () => {
        ...
        cy.get("div.ant-modal-content button.ant-btn-primary")
          .should("exist")
          .click();
