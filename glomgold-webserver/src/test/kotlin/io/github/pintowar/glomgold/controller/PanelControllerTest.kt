...
import io.github.pintowar.glomgold.dto.BalancePercent
    ...
    private val panelClient: PanelClient
        ...
        describe("panel operations - show panel") {
            ...
            it("show panel") {
                ...
                result.body
                    .get()
                    .items.size shouldBe totalItems
                result.body
                    .get()
                    .stats.size shouldBe (totalItems / 2)
        ...
        describe("panel operations - edit panel") {
            ...
            it("copy items to next month") {
                ...
                val actualItems =
                    fakeItems(userId, totalItems).map { item ->
                        item.apply {
        ...
        describe("panel operations - show report") {
            ...
            it("show empty report (past search)") {
                ...
                result.body
                    .get()
                    .columns.size shouldBe expectedCols
                ...
                result.body
                    .get()
                    .rowSummary.size shouldBe expectedCols
                result.body
                    .get()
                    .rowTrend.size shouldBe expectedCols
