...
abstract class CrudRestController<E : Any, DTO : Any, ID : Any>(
    private val repository: EntityRepository<E, ID>
) {
    ...
    open suspend fun index(
        @RequestBean pagination: RefinePaginateQuery
